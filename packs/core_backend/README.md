...
```
nomad-pack run core_backend --var message="Hola Mundo!"
```
...
- `register_service` (bool: true) - If you want to register a Nomad service
  for the job
- `service_tags` (list of string) - The service tags for the core_backend application
- `service_name` (string) - The service name for the core_backend application
